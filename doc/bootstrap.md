...
### Download the Blockchain from the PitbullcoinNode Project

The Pitbullcoin node project provides multiple and regulaly updated direct-link downloads. Copies of bootstrap.dat can be downloaded directly from servers provided by PitbullcoinNode, or be downloaded from a randomly selected server. All copies of boootstrap are updated at the maximum of every six months.

**Copies of Bootstrap from a specific server**

* [http://mango.pitbullcoinnode.org/bootstrap.dat](http://mango.pitbullcoinnode.org/bootstrap.dat)
* [http://apple.pitbullcoinnode.org/bootstrap.dat](http://apple.pitbullcoinnode.org/bootstrap.dat)

**Randomly selected dopy of Bootstrap**

This could be useful for use in scripts.

* [http://bootstrap.pitbullcoinnode.org/bootstrap.dat](http://bootstrap.pitbullcoinnode.org/bootstrap.dat)
	
**Example usage in a (bash) Terminal**

	wget http://bootstrap.pitbullcoinnode.org/bootstrap.dat       //downloads bootstrap into current directory
