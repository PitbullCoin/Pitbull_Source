...
std::string HelpMessageCli()
{
    ...
    strUsage += "\n" + _("SSL options: (see the Pitbullcoin Wiki for SSL setup instructions)") + "\n";
...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  pitbullcoin-cli [options] <command> [params]  " + _("Send command to Pitbullcoin Core") + "\n" +
                  "  pitbullcoin-cli [options] help                " + _("List commands") + "\n" +
                  "  pitbullcoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
