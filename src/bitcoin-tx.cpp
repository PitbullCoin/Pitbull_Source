...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Pitbullcoin Core pitbullcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pitbullcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pitbullcoin transaction") + "\n" +
              "  pitbullcoin-tx [options] -create [commands]   " + _("Create hex-encoded pitbullcoin transaction") + "\n" +
              "\n";
