...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"pitbullcoinaddress\"\n"
            "\nReturn information about the given pitbullcoin address.\n"
            "\nArguments:\n"
            "1. \"pitbullcoinaddress\"     (string, required) The pitbullcoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"pitbullcoinaddress\", (string) The pitbullcoin address validated\n"
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are pitbullcoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) pitbullcoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"pitbullcoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"pitbullcoinaddress\"  (string, required) The pitbullcoin address to use for the signature.\n"
