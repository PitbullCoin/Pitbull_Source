...
#if defined(NDEBUG)
# error "Pitbullcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Pitbullcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("pitbullcoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Pitbullcoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Pitbullcoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
